<%@ Page Title="" Language="C#" MasterPageFile="~/default_layout.Master" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="web.EditProduct_Code" %>
    ...
    <asp:Table ID="tblProductEdit" runat="server" Width="600px">
        ...
        <asp:TableFooterRow>
            ...
            <asp:TableCell ColumnSpan="3" HorizontalAlign="Right">
                <asp:Button ID="btDelete" runat="server" Text="Produkt löschen" OnClick="btDelete_Click" Height="50px" Width="200px" BackColor="#CF323D" ForeColor="White" Font-Bold="true" Enabled="false" />
            </asp:TableCell>
        </asp:TableFooterRow>
    </asp:Table>
