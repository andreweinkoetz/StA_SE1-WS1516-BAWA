...
namespace bll
{
    ...
    internal class clsUserCollection : clsBLLCollections
    {
        ...
        public int UpdateUser(clsUser _User)
        {
            ...
            _myDAL.AddParam("Prename", _User.Name, DAL.DataDefinition.enumerators.SQLDataType.VARCHAR);
        ...
        public string getPasswordOfAUser(string _name)
        {
        ...
        public int getIDOfAUser(string _name)
        {
        ...
        public int getRoleOfAUser(string _name)
        {
